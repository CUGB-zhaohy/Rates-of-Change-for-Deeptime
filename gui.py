...
class RoCGUI(tk.Tk):
    ...
    def _build_roc_tab(self):
        ...
        note_text = (
            ...
            "with a 50 kyr step.\n\n"
            "4. Distance-count weighted interpolation fills an internal missing "
            "target using only the nearest valid bin on each side. More distant "
            "valid bins do not contribute.\n\n"
            "5. Edge mode controls how missing values at the beginning or end of "
